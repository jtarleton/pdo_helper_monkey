...
class CustomersTable extends Baseobject{
    public static function get($id, $data=null) {
		return new Customers($id, $data);
    }
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare("SELECT * FROM Customers  LIMIT $offset,$limit;");
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('INSERT INTO Customers (cid,ad_title) VALUES(:cid,:ad_title)');
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('UPDATE Customers SET cid=:cid,ad_title=:ad_title');
